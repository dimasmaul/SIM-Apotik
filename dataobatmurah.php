...
<?php
	include 'db.php';
	$QuerySql = "SELECT * FROM `obat`, `jenis_obat` WHERE jenis_obat.kode_jenis=obat.kode_jenis ORDER BY `harga_obat` ASC";
	$SQL = mysqli_query($connect, $QuerySql);
?>

<!--Dimas Restu Maulana Membuat function mengurutkan data obat dari yang termurah ke yang paling mahal-->
